...
onmessage = function(e) {
    ...
    console.log('[rational] solving: digit=' + digit + ' target=' + target + ' max=' + maxDigits);
    ...
    function sendResult() {
        ...
        console.log('[rational] done. stdout=' + stdout.length + ' bytes');
    ...
    var Module = {
        ...
        quit: function(status) {
            ...
            console.log('[rational] quit with status ' + status);
            sendResult();
        },
        onExit: function(status) {
            console.log('[rational] onExit with status ' + status);
            sendResult();
        }
    };
    ...
    try {
        ...
        console.log('[rational] importScripts error:', err);
