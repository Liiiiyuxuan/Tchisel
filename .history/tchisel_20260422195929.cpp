...
const long long MAX_VAL = 10000000000000000LL; // 1e14
const int MAX_SET_SIZE = 10000000000;

// ─── Expression quality ─────────────────────────────────
// Lower score = cleaner expression. 
// We penalize negations heavily so the solver prefers positive-form expressions.
...
int main(int argc, char* argv[]) {
    ...
    if (max_digits < 1) {
        cerr << "Error: max digits must be greater than 0" << endl;
        return 1;
    }
