...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # Run solver ONCE with full max_digits — it checks every set as it goes
        ...
        # The solver outputs "  <target> = <expression>" on success
        digits_found = None
        formula = None

        # Check for "SOLVED in N digit(s)!" to get the digit count
