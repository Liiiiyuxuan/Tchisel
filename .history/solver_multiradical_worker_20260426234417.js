...
// Web Worker for the multiradical/symbolic Tchisla solver via WASM
...
try {
    ...
    postMessage({ type: 'result', result: { found: false, error: 'Failed to load solver_multiradical.js: ' + e.message } });
}
