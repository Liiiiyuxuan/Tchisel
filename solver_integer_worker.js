...
onmessage = function(e) {
    ...
    console.log('[integer] solving: digit=' + digit + ' target=' + target + ' max=' + maxDigits);
    ...
    function sendResult() {
        ...
        console.log('[integer] done. stdout=' + stdout.length + ' bytes');
    ...
    var Module = {
        ...
        quit: function(status) {
            ...
            console.log('[integer] quit with status ' + status);
            sendResult();
        },
        onExit: function(status) {
            console.log('[integer] onExit with status ' + status);
            sendResult();
        }
    };
    ...
    try {
        ...
        console.log('[integer] importScripts error:', err);
